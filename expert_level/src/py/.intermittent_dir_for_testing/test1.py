...
my_parser.add_argument("Method",metavar='tm_method',type=int,choices=range(1,3),help="0 for Cross Coefficent norm, 1 for Cross Correlation norm, 2 for Square Differnce norm")      #adding template method argument
...
template_gray = cv.imread('resize_template.png',0)       #loading the template image in grayscale
